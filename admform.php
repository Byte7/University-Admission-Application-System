...
<tr>
                <td class="tablecontent2">&nbsp;&nbsp;&nbsp;&nbsp Age as on 07.10.2016
 </td>
...
{  
  ...
  echo " Cannot SUBMIT , Check mandatory  fields are empty !";
	...
	else
	{
		if($age < 18)
		{
			echo "<center><br>You are not eligible to apply as you are below 20 years<br>";
		...
		else
		{
			...
			{
				mysqli_query($conn, "insert into pdetails
